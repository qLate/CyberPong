...
#include "Bluetooth_1_eventHandler.h"
...
void Bluetooth_1_uart_Start (void);
void Bluetooth_1_uart_Stop (void);
void Bluetooth_1_uart_Transmit (const uint8 *dataBuf, uint8 length);
