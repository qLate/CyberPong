...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F335Fu, /* Base address: 0x400F3300 Count: 95 */
		...
		static const uint8 CYCODE BS_UDB_0_0_1_CONFIG_VAL[] = {
			0x00u, 0x00u, 0x08u, 0x20u, 0x22u, 0x00u, 0x1Cu, 0x40u, 0x08u, 0x02u, 0x14u, 0x04u, 0x06u, 0x01u, 0x30u, 0x00u, 
			0x04u, 0x1Bu, 0x02u, 0x24u, 0x1Eu, 0x00u, 0x20u, 0x81u, 0x02u, 0x35u, 0x01u, 0x0Au, 0x00u, 0x2Cu, 0x00u, 0x10u, 
			0x00u, 0x80u, 0x40u, 0x40u, 0x00u, 0x80u, 0x02u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x08u, 0x00u, 0x00u, 
			0x06u, 0x00u, 0x38u, 0x3Fu, 0x40u, 0xC0u, 0x01u, 0x00u, 0x00u, 0x00u, 0x0Au, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0xEE003030u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x33993333u);

		/* UDB_PA_0 Starting address: CYDEV_UDB_PA0_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA0_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x00190000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0xD01E0000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00D92CB2u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x000000EFu);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC), 0x00000032u);
